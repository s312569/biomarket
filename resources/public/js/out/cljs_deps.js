...
goog.addDependency("../biomarket/projectdisplay.js", ['biomarket.projectdisplay'], ['biomarket.server', 'biomarket.utilities', 'cljs.core', 'om.dom', 'cljs.core.async', 'cljs.pprint', 'biomarket.bids', 'biomarket.skills', 'om.core', 'biomarket.dropdown', 'biomarket.comments', 'clojure.string']);
goog.addDependency("../biomarket/newproject.js", ['biomarket.newproject'], ['biomarket.server', 'biomarket.utilities', 'cljs.core', 'om.dom', 'goog.history.EventType', 'goog.History', 'cljs.core.async', 'cljs_time.core', 'biomarket.skills', 'om.core', 'secretary.core', 'cljs_time.format', 'clojure.string', 'goog.events']);
...
goog.addDependency("../biomarket/jobs.js", ['biomarket.jobs'], ['biomarket.login', 'biomarket.projectdisplay', 'biomarket.server', 'biomarket.utilities', 'cljs.core', 'om.dom', 'goog.history.EventType', 'goog.History', 'cljs.core.async', 'biomarket.bids', 'om.core', 'secretary.core', 'clojure.string', 'biomarket.newproject', 'goog.events']);
goog.addDependency("../biomarket/profile.js", ['biomarket.profile'], ['ajax.core', 'biomarket.server', 'biomarket.utilities', 'cljs.core', 'om.dom', 'cljs.core.async', 'taoensso.sente', 'om.core', 'clojure.string', 'goog.events']);
