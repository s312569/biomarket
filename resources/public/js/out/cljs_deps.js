...
goog.addDependency("../biomarket/components.js", ['biomarket.components'], ['ajax.core', 'biomarket.server', 'biomarket.utilities', 'cljs.core', 'om.dom', 'cljs.core.async', 'taoensso.sente', 'om.core', 'clojure.string', 'goog.events']);
goog.addDependency("../biomarket/skills.js", ['biomarket.skills'], ['ajax.core', 'biomarket.utilities', 'cljs.core', 'om.dom', 'cljs.core.async', 'cljs_time.core', 'cljs.pprint', 'taoensso.sente', 'om.core', 'cljs_time.format', 'clojure.string', 'goog.events', 'biomarket.components']);
goog.addDependency("../biomarket/comments.js", ['biomarket.comments'], ['biomarket.server', 'biomarket.utilities', 'cljs.core', 'om.dom', 'goog.history.EventType', 'goog.History', 'cljs.core.async', 'cljs_time.core', 'om.core', 'secretary.core', 'cljs_time.format', 'clojure.string', 'goog.events', 'biomarket.components']);
goog.addDependency("../biomarket/bids.js", ['biomarket.bids'], ['biomarket.server', 'biomarket.utilities', 'cljs.core', 'om.dom', 'goog.history.EventType', 'goog.History', 'cljs.core.async', 'cljs_time.core', 'biomarket.skills', 'om.core', 'secretary.core', 'cljs_time.format', 'biomarket.comments', 'clojure.string', 'goog.events', 'biomarket.components']);
goog.addDependency("../biomarket/projectdisplay.js", ['biomarket.projectdisplay'], ['biomarket.server', 'biomarket.utilities', 'cljs.core', 'om.dom', 'cljs.core.async', 'cljs.pprint', 'biomarket.bids', 'biomarket.skills', 'om.core', 'biomarket.comments', 'clojure.string', 'biomarket.components']);
