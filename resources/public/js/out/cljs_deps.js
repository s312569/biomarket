...
goog.addDependency("../biomarket/utilities.js", ['biomarket.utilities'], ['ajax.core', 'cljs.core', 'om.dom', 'cljs.core.async', 'cljs_time.core', 'cljs.pprint', 'om.core', 'cljs_time.format', 'clojure.string', 'goog.events']);
goog.addDependency("../clojure/walk.js", ['clojure.walk'], ['cljs.core']);
goog.addDependency("../secretary/core.js", ['secretary.core'], ['cljs.core', 'clojure.string', 'clojure.walk']);
goog.addDependency("../biomarket/login.js", ['biomarket.login'], ['biomarket.utilities', 'cljs.core', 'om.dom', 'cljs.core.async', 'om.core', 'secretary.core', 'goog.events']);
goog.addDependency("../biomarket/bids.js", ['biomarket.bids'], ['biomarket.utilities', 'cljs.core', 'om.dom', 'goog.history.EventType', 'goog.History', 'cljs.core.async', 'cljs_time.core', 'om.core', 'secretary.core', 'cljs_time.format', 'clojure.string', 'goog.events']);
goog.addDependency("../biomarket/newproject.js", ['biomarket.newproject'], ['biomarket.utilities', 'cljs.core', 'om.dom', 'goog.history.EventType', 'goog.History', 'cljs.core.async', 'cljs_time.core', 'om.core', 'secretary.core', 'cljs_time.format', 'clojure.string', 'goog.events']);
goog.addDependency("../biomarket/projects.js", ['biomarket.projects'], ['biomarket.login', 'biomarket.utilities', 'cljs.core', 'om.dom', 'goog.history.EventType', 'goog.History', 'cljs.core.async', 'biomarket.bids', 'om.core', 'secretary.core', 'clojure.string', 'biomarket.newproject', 'goog.events']);
goog.addDependency("../biomarket/comments.js", ['biomarket.comments'], ['biomarket.utilities', 'cljs.core', 'om.dom', 'goog.history.EventType', 'goog.History', 'cljs.core.async', 'cljs_time.core', 'om.core', 'secretary.core', 'cljs_time.format', 'clojure.string', 'goog.events']);
goog.addDependency("../biomarket/find.js", ['biomarket.find'], ['biomarket.utilities', 'cljs.core', 'om.dom', 'goog.history.EventType', 'goog.History', 'cljs.core.async', 'cljs_time.core', 'biomarket.bids', 'om.core', 'secretary.core', 'cljs_time.format', 'biomarket.comments', 'clojure.string', 'goog.events']);
...
goog.addDependency("../biomarket/core.js", ['biomarket.core'], ['biomarket.login', 'biomarket.projects', 'biomarket.utilities', 'biomarket.find', 'cljs.core', 'om.dom', 'goog.history.EventType', 'goog.History', 'cljs.core.async', 'taoensso.sente', 'om.core', 'secretary.core', 'goog.events', 'biomarket.dashboard']);
