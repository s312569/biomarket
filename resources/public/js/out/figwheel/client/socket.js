...
figwheel.client.socket.open = (function figwheel$client$socket$open(p__39763){
var map__39766 = p__39763;
var map__39766__$1 = ((((!((map__39766 == null)))?((((map__39766.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39766.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39766):map__39766);
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4423__auto__,map__39766,map__39766__$1,opts,retry_count,retried_count,websocket_url,build_id){
...
var and__25868__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__25868__auto__){
var and__25868__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__25868__auto____$1)){
var and__25868__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
...
});})(url,socket,WebSocket,temp__4423__auto__,map__39766,map__39766__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4423__auto__,map__39766,map__39766__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4423__auto__,map__39766,map__39766__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__25880__auto__ = retried_count;
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4423__auto__,map__39766,map__39766__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4423__auto__,map__39766,map__39766__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__26218__auto__ = (10000);
var y__26219__auto__ = ((2000) + ((500) * retried_count__$1));
...
socket.onerror = ((function (url,socket,WebSocket,temp__4423__auto__,map__39766,map__39766__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
